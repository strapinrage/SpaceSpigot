...
public abstract class Entity implements ICommandListener {
	...
	public boolean invulnerable; // SpaceSpigot - private -> public
	...
	public double c(BlockPosition blockposition) {
		...
		// SpaceSpigot - reduce usage of block position
		return distanceSquared(blockposition.getX(), blockposition.getY(), blockposition.getZ());
	}
	
	// SpaceSpigot start - reduce usage of blockposition
	...
	public double distanceSqrdAccurate(Entity entity) {
		...
		if (SpaceSpigotConfig.improvedHitDetection && entity instanceof EntityPlayer && this instanceof EntityPlayer) {
			...
			if (entityPlayer.playerConnection.getClass().equals(PlayerConnection.class)
				...
				loc = SpaceSpigot.getInstance().getLagCompensator().getHistoryLocation(entityPlayer.getBukkitEntity(),
						player.ping);
			} else {
