...
public abstract class MobSpawnerAbstract {
	...
	public MobSpawnerAbstract() {
		// SpaceSpigot start - configurable spawner settings
		this.spawnDelay = SpaceSpigotConfig.spawnersInitialSpawnDelay;
		this.minSpawnDelay = SpaceSpigotConfig.spawnersMinSpawnDelay;
		this.maxSpawnDelay = SpaceSpigotConfig.spawnersMaxSpawnDelay;
		this.spawnCount = SpaceSpigotConfig.spawnersSpawnCount;
		this.spawnRange = SpaceSpigotConfig.spawnersSpawnRange;
		this.maxNearbyEntities = SpaceSpigotConfig.spawnersMaxNearbyEntities;
		this.requiredPlayerRange = SpaceSpigotConfig.spawnersRequiredPlayerRange;
		// SpaceSpigot end
	}
	...
	public void c() {
		...
		if (this.g()) {
			...
			if (this.a().isClientSide) {
				...
				// SpaceSpigot start - configurable spawner animations
				if (SpaceSpigotConfig.spawnerAnimation) {
