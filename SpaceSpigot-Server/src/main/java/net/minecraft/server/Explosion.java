...
public class Explosion {
			...
			if (!entity.aW()) {
				if (!entity.dead) {
					...
					if (distanceSquared <= 64.0D && distanceSquared != 0.0D) {
						...
						// SpaceSpigot start - toggleable async explosions
	...
	public void a(boolean flag) {
		...
		// SpaceSpigot start - configurable explosion sounds
		if (SpaceSpigotConfig.explosionSounds) {
		...
		// SpaceSpigot start - configurable explosion animations
		if (SpaceSpigotConfig.explosionAnimation) {
		...
		if (this.b) {
			...
			if (explode != null) {
				...
				if (SpaceSpigotConfig.fireEntityExplodeEvent) {
