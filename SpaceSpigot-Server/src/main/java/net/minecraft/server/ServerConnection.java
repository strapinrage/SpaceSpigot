...
import net.strapinrage.spacespigot.protocol.MinecraftPipeline;
...
public class ServerConnection {
	...
	public void a(InetAddress ip, int port) throws IOException {
		synchronized (this.getListeningChannels()) {
			...
			LOGGER.info("SpaceSpigot: Using " + Natives.compress.getLoadedVariant() + " compression from Velocity.");
			LOGGER.info("SpaceSpigot: Using " + Natives.cipher.getLoadedVariant() + " cipher from Velocity.");
			// Paper end
