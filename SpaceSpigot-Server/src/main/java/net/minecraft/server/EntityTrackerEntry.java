...
// SpaceSpigot - sendPacket methods have been replaced with the queuePacket method
public class EntityTrackerEntry {
	...
	// SpaceSpigot - re add removed method used by Citizens
	public EntityTrackerEntry(Entity entity, int b, int c, boolean flag) {

		// SpaceSpigot Start - get the entity's tracker from it's dimension
