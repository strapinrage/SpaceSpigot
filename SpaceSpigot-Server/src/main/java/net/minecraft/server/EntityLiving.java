...
public abstract class EntityLiving extends Entity {
	...
	public EntityLiving(World world) {
		...
		this.k = true;
		// SpaceSpigot start - use faster randoms
	...
	public void b(ItemStack itemstack) {
		...
		for (int i = 0; i < 5; ++i) {
			// SpaceSpigot - use faster randoms
	...
	public void a(double x, double z, DamageSource source) {
		if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
			...
			// SpaceSpigot start - correct knockback friction (change to division instead of multiplication)
			...
			// SpaceSpigot start - knockback addition config
	...
	public void m() {
		...
		// SpaceSpigot start - smoother mob AI disable
	...
	public boolean hasLineOfSightAccurate(Entity entity) {
		...
		if (entity instanceof EntityPlayer && SpaceSpigotConfig.improvedHitDetection) {
