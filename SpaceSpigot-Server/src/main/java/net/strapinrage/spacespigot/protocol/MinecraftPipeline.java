package net.strapinrage.spacespigot.protocol;
...
public class MinecraftPipeline extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel channel) {
		try {
			...
			config.setOption(ChannelOption.TCP_NODELAY, SpaceSpigotConfig.enableTCPNODELAY);
			config.setOption(ChannelOption.TCP_FASTOPEN, SpaceSpigotConfig.modeTcpFastOpen);
			config.setOption(ChannelOption.TCP_FASTOPEN_CONNECT, SpaceSpigotConfig.enableTcpFastOpen);
