...
import net.strapinrage.spacespigot.commons.ClickableBuilder;
import net.strapinrage.spacespigot.knockback.CraftKnockbackProfile;
...
public class KnockbackCommand extends Command {
	...
	public KnockbackCommand(String name) {
		...
		this.setPermission("spacespigot.command.knockback");
	}
